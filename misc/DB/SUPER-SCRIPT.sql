...
BEGIN
	IF EXISTS (SELECT CI_01 FROM TRO_01 WHERE CI_01=ID) THEN
		IF NOT EXISTS (SELECT CI_01 FROM TUS_01 WHERE CR_05=ID) THEN
			DELETE FROM TPRR_01 WHERE CRO_01=ID;
...
$BODY$
BEGIN
	IF NOT EXISTS (SELECT CI_01 FROM TSE_01 WHERE CI_01=ID) THEN
		RAISE EXCEPTION '11';
	ELSE
		IF EXISTS(SELECT CI_01 FROM TTR_01 WHERE CS_04=ID) THEN 
			RAISE EXCEPTION '30';
		ELSE
			IF EXISTS (SELECT CI_01 FROM TRO_01 WHERE CS_03=ID) THEN
				RAISE EXCEPTION '31';
			ELSE
				IF EXISTS (SELECT CI_01 FROM TUS_01 WHERE CS_06=ID) THEN
					RAISE EXCEPTION '32';
				ELSE
					DELETE FROM TTDF_01 WHERE CLO_03=ID;
					DELETE FROM TTDC_01 WHERE CLO_05=ID;
...
BEGIN
	...
	IF NOT EXISTS (SELECT CI_01 FROM TTR_01 WHERE CI_01=ID) THEN
		RAISE EXCEPTION '1';
	ELSE
		IF EXISTS (SELECT CI_01 FROM TDF_01 WHERE CTR_02=ID) THEN
			RAISE EXCEPTION '33';
		ELSE
			IF EXISTS (SELECT CI_01 FROM TDC_01 WHERE CTR_02=ID) THEN
				RAISE EXCEPTION '33';
			ELSE
				IF EXISTS (SELECT CI_01 FROM TMU_01 WHERE CTR_02=ID) THEN
					RAISE EXCEPTION '34';
				ELSE
...
BEGIN
	IF EXISTS( SELECT CI_01 FROM TTDF_01 WHERE CI_01=ID) THEN
		IF NOT EXISTS (SELECT CI_01 FROM TDF_01 WHERE CTY_05=ID) THEN
...
BEGIN
	IF EXISTS( SELECT CI_01 FROM TTDC_01 WHERE CI_01=ID) THEN
		IF NOT EXISTS (SELECT CI_01 FROM TDC_01 WHERE CTY_09=ID) THEN
