...
namespace SistemaDePlanillas.Models.Operations
{
    public class EmployeesGroup
    {
        ...
        {
            var result = DBManager.getInstance().addCmsEmployee(idCard, idCMS, name, (int)user.location, BCRAccount);
        ...
        {
            var result = DBManager.getInstance().addCmsEmployee(idCard, idCMS, name, (int)location, BCRAccount);
            return Responses.Simple(result.status);
        }
        ...
        {
            var result = DBManager.getInstance().addNonCmsEmployee(idCard, name, (int)user.location, BCRAccount, (float)salary);
            return Responses.Simple(result.status);
        }
        ...
        {
            var result = DBManager.getInstance().addNonCmsEmployee(idCard, name, (int)location, BCRAccount, (float)salary);
            return Responses.Simple(result.status);
        }
        ...
        {
            var result = DBManager.getInstance().updateCmsEmployeee((int)id, idCard, idCMS, name, (int)location, BCRAccount);
            return Responses.Simple(result.status);
        }
        ...
        {
            var result = DBManager.getInstance().updateNonCmsEmployeee((int)id, idCard, name, (int)location, BCRAccount, (float)salary);
            return Responses.Simple(result.status);
        }
        ...
        {
            var result = DBManager.getInstance().deleteEmployee((int)id);
            return Responses.Simple(result.status);
        }
        ...
        {
            var result = DBManager.getInstance().selectAllEmployees((int)user.location);
        ...
        {
            var result = DBManager.getInstance().selectAllCmsEmployees((int)user.location);
            return Responses.SimpleWithData(result.status, result.detail);
        }
        ...
        {
            var result = DBManager.getInstance().selectAllNonCmsEmployees((int)user.location);
            return Responses.SimpleWithData(result.status, result.detail);
        }

        public static string get(User user, long id)
        {
            var result = DBManager.getInstance().selectEmployee((int)id);
            return Responses.SimpleWithData(result.status, result.detail);
        }
    }
}